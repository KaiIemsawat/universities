...
<head>
	<meta charset="UTF-8">
	<title>Edit ${editHall.hallName}</title>
	<!-- Bootstrap Link -->
...
<body>
	...
	<div class="container-fluid">
		<h1>Edit ${editHall.hallName}</h1>
		<form:form action="/halls/${editHall.id}/edit" method="POST" modelAttribute="editHall"> <!-- match with editTheHallPage() and editTheHall() -->
			<p> 
